...
//eslint-disable-next-line
 useEffect(() => {
   async function getRecords() {
     const response = await fetch(`http://localhost:5000/cats/viewcat/${id}`);
